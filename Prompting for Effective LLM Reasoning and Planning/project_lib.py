...
def print_in_box(text, title="", cols=180, tab_level=0):
    """
...
WEATHER_FORECAST = [
    ...
    },
    {
        ...
        "temperature_unit": "celsius",
        "condition": "partly cloudy",
        "description": "Cloudy skies with periods of sunshine and mixed clouds throughout the day, accompanied by a cool breeze.",
    },
    {
        "date": "2025-06-14",
        "city": "AgentsVille",
        ...
        "temperature_unit": "celsius",
        "condition": "cloudy",
        "description": "Cloudy skies throughout the day, accompanied by cool temperatures.",
    },
    {
        "date": "2025-06-15",
        "city": "AgentsVille",
